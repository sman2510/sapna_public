...
var SettingComponent = /** @class */ (function () {
    function SettingComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    SettingComponent.prototype.getData = function () {
        var _this = this;
        this.apiService.getData('setting/details?pageName=setting').subscribe(function (res) {
            _this.detailForm.controls['client_key'].setValue(res['data'].client_key);
            _this.detailForm.controls['secret_key'].setValue(res['data'].secret_key);
            _this.detailForm.controls['min_redeem'].setValue(res['data'].min_redeem);
            _this.detailForm.controls['max_redeem'].setValue(res['data'].max_redeem);
            _this.detailForm.controls['referred_amount'].setValue(res['data'].referred_amount);
            _this.detailForm.controls['month'].setValue(res['data'].session_end.split('-')[1]);
            _this.detailForm.controls['day'].setValue(res['data'].session_end.split('-')[0]);
            _this.detailForm.controls['vendor_per'].setValue(res['data'].vendor_per);
        }, function (error) {
            if (error['error']) {
    ...
    SettingComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData('setting/add', this.detailForm.value).subscribe(function (res) {
    ...
    Object.defineProperty(SettingComponent.prototype, "fval", {
        get: function () {
