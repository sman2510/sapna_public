...
var TopicListRoutingModule = /** @class */ (function () {
    function TopicListRoutingModule() {
    }
...
var TopicListComponent = /** @class */ (function () {
    function TopicListComponent(apiService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    TopicListComponent.prototype.getClassData = function () {
        var _this = this;
        this.apiService.getData('class/list?pageName=topic').subscribe(function (res) {
            _this.classData = res['data'];
        });
    };
    TopicListComponent.prototype.getSubjectData = function (event) {
        var _this = this;
        var value;
    ...
    TopicListComponent.prototype.getChapterData = function (event) {
        var _this = this;
        var value;
        if (event && event.target && event.target.value) {
            value = event.target.value;
    ...
    TopicListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('topic/list?pageName=topic').subscribe(function (res) {
    ...
    TopicListComponent.prototype.editData = function (id) {
        var _this = this;
        this.SpinnerService.show();
        this.editID = id;
        this.apiService.getData('topic/list/' + this.editID + '?pageName=topic').subscribe(function (res) {
            _this.getSubjectData(res['data'].chapter.subject.class_id);
            _this.getChapterData(res['data'].chapter.subject_id);
            _this.detailForm.controls['class_id'].setValue(res['data'].chapter.subject.class_id);
            _this.detailForm.controls['subject_id'].setValue(res['data'].chapter.subject_id);
            _this.detailForm.controls['chapter_id'].setValue(res['data'].chapter.id);
            _this.detailForm.controls['topic_name'].setValue(res['data'].topic_name);
            _this.detailForm.controls['description'].setValue(res['data'].description);
            _this.SpinnerService.hide();
        });
    };
    TopicListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
    ...
    TopicListComponent.prototype.uploadFile = function (event) {
    ...
    TopicListComponent.prototype.deleteData = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.apiService.saveData('topic/delete?pageName=topic', obj).subscribe(function (res) {
                    _this.listGetData();
                    _this.toastr.success(res['message']);
                });
            }
    ...
    TopicListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    TopicListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(TopicListComponent.prototype, "fval", {
        get: function () {
    ...
    TopicListComponent.ctorParameters = function () { return [
...
var TopicListModule = /** @class */ (function () {
    function TopicListModule() {
    }
...
//# sourceMappingURL=topicList-topicList-module-es5.js.map