...
describe("DataTable directive tests", function () {
    ...
    beforeEach(function () {
        ...
        datatable.ngOnChanges({ inputData: new core_1.SimpleChange(null, datatable.inputData, false) });
    });
    describe("initializing", function () {
        it("data should be empty array if inputData is undefined or null", function () {
            datatable.ngOnChanges({ inputData: new core_1.SimpleChange(null, null, false) });
            datatable.ngDoCheck();
    ...
    describe("pagination", function () {
        ...
        it("should change rowsOnPage when svRowsOnPage changed", function (done) {
            datatable.rowsOnPage = 2;
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 3, name: 'banana' }, { id: 1, name: 'Duck' }]);
            ...
            datatable.ngOnChanges({ rowsOnPage: new core_1.SimpleChange(2, 3, false) });
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([{ id: 3, name: 'banana' }, { id: 1, name: 'Duck' }, { id: 2, name: 'ącki' }]);
        });
    });
    describe("sorting", function () {
        ...
        it("should sort data after sorting input value changed", function () {
            ...
            datatable.ngOnChanges({
                sortBy: new core_1.SimpleChange(null, datatable.sortBy, true),
                sortOrder: new core_1.SimpleChange(null, datatable.sortOrder, true)
            });
            datatable.ngDoCheck();
            expect(datatable.data).toEqual([
                { id: 1, name: 'Duck' },
        ...
        it("should fire onSortChange event after sorting input value changed", function (done) {
            ...
            datatable.ngOnChanges({
                sortBy: new core_1.SimpleChange(null, datatable.sortBy, false),
                sortOrder: new core_1.SimpleChange(null, datatable.sortOrder, false)
            });
            datatable.ngDoCheck();
        });
        ...
        it("shouldn't change order when only order provided", function (done) {
            ...
            datatable.ngDoCheck();
            datatable.sortOrder = "desc";
            datatable.ngOnChanges({ sortOrder: new core_1.SimpleChange(null, datatable.sortOrder, false) });
            datatable.ngDoCheck();
            expect(datatable.data).toEqual(datatable.inputData);
        });
        it("should call output event when sorting changed", function (done) {
            datatable.ngDoCheck();
            datatable.sortByChange.pipe(operators_1.switchMap(function (sortBy) {
        ...
        it("should sort data by two values", function () {
            ...
            datatable.ngOnChanges({ inputData: new core_1.SimpleChange(datatable.inputData, newData, false) });
