...
var VideoListRoutingModule = /** @class */ (function () {
    function VideoListRoutingModule() {
    }
...
var VideoListComponent = /** @class */ (function () {
    function VideoListComponent(apiService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    VideoListComponent.prototype.getTeacherData = function () {
        var _this = this;
        this.apiService
    ...
    VideoListComponent.prototype.getClassData = function () {
        var _this = this;
        this.apiService
    ...
    VideoListComponent.prototype.getSubjectData = function (event) {
        var _this = this;
        var value;
    ...
    VideoListComponent.prototype.getChapterData = function (event) {
        var _this = this;
        var value;
        if (event && event.target && event.target.value) {
            value = event.target.value;
        ...
        this.apiService.getData(url).subscribe(function (res) {
            _this.chapterData = res["data"].chapter;
        });
    };
    VideoListComponent.prototype.getTopicData = function (event) {
        var _this = this;
        var value;
        if (event && event.target && event.target.value) {
            value = event.target.value;
        ...
        this.apiService.getData(url).subscribe(function (res) {
            _this.topicData = res["data"].topic;
        });
    };
    VideoListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData("video/list?pageName=video").subscribe(function (res) {
    ...
    VideoListComponent.prototype.editData = function (id) {
        var _this = this;
        this.SpinnerService.show();
        this.editID = id;
        this.apiService
            ...
            .subscribe(function (res) {
            _this.getSubjectData(res["data"].topic.chapter.subject.class_id);
            _this.getChapterData(res["data"].topic.chapter.subject.id);
            _this.getTopicData(res["data"].topic.chapter.id);
            _this.detailForm.controls["class_id"].setValue(res["data"].topic.chapter.subject.class_id);
            _this.detailForm.controls["subject_id"].setValue(res["data"].topic.chapter.subject.id);
            _this.detailForm.controls["teacher_id"].setValue(res["data"].teacher_id);
            _this.detailForm.controls["chapter_id"].setValue(res["data"].topic.chapter.id);
            _this.detailForm.controls["topic_id"].setValue(res["data"].topic_id);
            _this.detailForm.controls["type"].setValue(res["data"].type);
            _this.detailForm.controls["title"].setValue(res["data"].title);
            _this.detailForm.controls["thumbnaiPath"].setValue(res["data"].thumbnail);
            _this.detailForm.controls["videoPath"].setValue(res["data"].video_url);
            _this.detailForm.controls["DocumentPath"].setValue(res["data"].document_url);
            _this.detailForm.controls["video_description"].setValue(res["data"].video_description);
            _this.detailForm.controls["document_description"].setValue(res["data"].document_description);
            _this.SpinnerService.hide();
        });
    };
    VideoListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.savePData(this.apiUrl, formData).subscribe(function (res) {
            _this.progress = Math.round((100 / res["total"]) * res["loaded"]);
            if (res["status"] == 200) {
                _this.SpinnerService.hide();
    ...
    VideoListComponent.prototype.uploadThumbnail = function (event) {
    ...
    VideoListComponent.prototype.uploadVideo = function (event) {
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
    ...
    VideoListComponent.prototype.uploadDoc = function (event) {
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
    ...
    VideoListComponent.prototype.deleteData = function (id, type) {
        var _this = this;
    ...
    VideoListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    VideoListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(VideoListComponent.prototype, "fval", {
        get: function () {
    ...
    VideoListComponent.prototype.generateQuiz = function (id) {
        sessionStorage.setItem("videoId", id);
        this.router.navigate(["/assessment"]);
    };
    VideoListComponent.prototype.viewQuiz = function (id) {
        sessionStorage.setItem("videoId", id);
...
var VideoListModule = /** @class */ (function () {
    function VideoListModule() {
    }
...
//# sourceMappingURL=videoList-videoList-module-es5.js.map