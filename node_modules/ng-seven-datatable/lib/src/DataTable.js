...
var DataTable = (function () {
    ...
    DataTable.propDecorators = {
        inputData: [{ type: core_1.Input, args: ["svData",] }],
        sortBy: [{ type: core_1.Input, args: ["svSortBy",] }],
        sortOrder: [{ type: core_1.Input, args: ["svSortOrder",] }],
        sortByChange: [{ type: core_1.Output, args: ["svSortByChange",] }],
        sortOrderChange: [{ type: core_1.Output, args: ["svSortOrderChange",] }],
        rowsOnPage: [{ type: core_1.Input, args: ["svRowsOnPage",] }],
        activePage: [{ type: core_1.Input, args: ["svActivePage",] }]
    };
    return DataTable;
}());
