...
var NotificationListRoutingModule = /** @class */ (function () {
    function NotificationListRoutingModule() {
    }
    ...
    return NotificationListRoutingModule;
}());
...
var NotificationListComponent = /** @class */ (function () {
    function NotificationListComponent(apiService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    NotificationListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('notification/list?pageName=notification').subscribe(function (res) {
    ...
    NotificationListComponent.prototype.editData = function (id) {
        var _this = this;
        this.SpinnerService.show();
        this.editID = id;
        this.apiService.getData('notification/list/' + this.editID + '?pageName=notification').subscribe(function (res) {
            _this.detailForm.controls['title'].setValue(res['data'].title);
            _this.detailForm.controls['date'].setValue(res['data'].date);
            _this.detailForm.controls['description'].setValue(res['data'].description);
            _this.SpinnerService.hide();
        });
    };
    NotificationListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
    ...
    NotificationListComponent.prototype.deleteData = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.apiService.saveData('notification/delete?pageName=notification', obj).subscribe(function (res) {
                    _this.listGetData();
                    _this.toastr.success(res['message']);
                });
            }
    ...
    NotificationListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    NotificationListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(NotificationListComponent.prototype, "fval", {
        get: function () {
...
//# sourceMappingURL=notificationList-notificationList-module-es5.js.map