...
var SubscriptionListRoutingModule = /** @class */ (function () {
    function SubscriptionListRoutingModule() {
    }
    ...
    return SubscriptionListRoutingModule;
}());
...
var SubscriptionListComponent = /** @class */ (function () {
    function SubscriptionListComponent(apiService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    SubscriptionListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('subscription/list?pageName=subscription').subscribe(function (res) {
    ...
    SubscriptionListComponent.prototype.editData = function (id) {
        var _this = this;
        this.SpinnerService.show();
        this.editID = id;
        this.apiService.getData('subscription/list/' + this.editID + '?pageName=subscription').subscribe(function (res) {
            _this.detailForm.controls['title'].setValue(res['data'].title);
            _this.detailForm.controls['price'].setValue(res['data'].price);
            _this.detailForm.controls['days'].setValue(res['data'].days);
            _this.SpinnerService.hide();
        });
    };
    SubscriptionListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
    ...
    SubscriptionListComponent.prototype.uploadFile = function (event) {
    ...
    SubscriptionListComponent.prototype.deleteData = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.apiService.saveData('subscription/delete?pageName=subscription', obj).subscribe(function (res) {
                    _this.listGetData();
                    _this.toastr.success(res['message']);
                });
            }
    ...
    SubscriptionListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    SubscriptionListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(SubscriptionListComponent.prototype, "fval", {
        get: function () {
...
//# sourceMappingURL=subscriptionList-subscriptionList-module-es5.js.map