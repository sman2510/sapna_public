...
var AboutusComponent = /** @class */ (function () {
    function AboutusComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    AboutusComponent.prototype.getData = function () {
        ...
        this.apiService.getData('company/details?pageName=company').subscribe(function (res) {
            _this.detailForm.controls['email_id'].setValue(res['data'].email_id);
            _this.detailForm.controls['mobile_no'].setValue(res['data'].mobile_no);
            _this.detailForm.controls['about'].setValue(res['data'].about);
    ...
    AboutusComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData('company/addEdit', formData).subscribe(function (res) {
            _this.SpinnerService.hide();
            if (res['status']) {
                _this.getData();
    ...
    Object.defineProperty(AboutusComponent.prototype, "fval", {
        get: function () {
