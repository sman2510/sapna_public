...
var StudentEditRoutingModule = /** @class */ (function () {
    function StudentEditRoutingModule() {
    }
    ...
    return StudentEditRoutingModule;
}());
...
var StudentEditComponent = /** @class */ (function () {
    function StudentEditComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    StudentEditComponent.prototype.getClassData = function () {
        var _this = this;
        this.apiService
    ...
    StudentEditComponent.prototype.getStateData = function () {
        var _this = this;
        this.apiService.getData("state/list").subscribe(function (res) {
            _this.stateData = res["data"];
        });
    };
    StudentEditComponent.prototype.getCityData = function (event) {
        var _this = this;
        var value;
    ...
    StudentEditComponent.prototype.getStudentData = function () {
        var _this = this;
        this.apiService
            .getData("student/list/" + this.studentId + "?pageName=student")
            .subscribe(function (res) {
            _this.getCityData(res["data"].student_details.state);
            ...
            _this.detailForm.controls["class"].setValue(res["data"].student_details.class);
            _this.detailForm.controls["dob"].setValue(res["data"].student_details.dob);
            _this.detailForm.controls["gender"].setValue(res["data"].student_details.gender);
            _this.detailForm.controls["state"].setValue(res["data"].student_details.state);
            _this.detailForm.controls["city"].setValue(res["data"].student_details.city);
        }, function (error) {
            if (error["error"]) {
    ...
    StudentEditComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
    ...
    Object.defineProperty(StudentEditComponent.prototype, "fval", {
        get: function () {
    ...
    StudentEditComponent.prototype.backUrl = function () {
        this.router.navigate(["/studentList"]);
    };
    StudentEditComponent.ctorParameters = function () { return [
...
var StudentEditModule = /** @class */ (function () {
    function StudentEditModule() {
    }
...
//# sourceMappingURL=studentEdit-studentEdit-module-es5.js.map