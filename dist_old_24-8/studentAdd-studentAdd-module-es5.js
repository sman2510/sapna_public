...
var StudentAddRoutingModule = /** @class */ (function () {
    function StudentAddRoutingModule() {
    }
    ...
    return StudentAddRoutingModule;
}());
...
var StudentAddComponent = /** @class */ (function () {
    function StudentAddComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    StudentAddComponent.prototype.getClassData = function () {
        var _this = this;
        this.apiService.getData('class/list?pageName=student').subscribe(function (res) {
            _this.classData = res['data'];
        });
    };
    StudentAddComponent.prototype.getStateData = function () {
        var _this = this;
        this.apiService.getData('state/list').subscribe(function (res) {
            _this.stateData = res['data'];
        });
    };
    StudentAddComponent.prototype.getCityData = function (event) {
        var _this = this;
        var value;
    ...
    StudentAddComponent.prototype.getPaymentData = function () {
        var _this = this;
        this.apiService.getData('paymentMethodList?pageName=student').subscribe(function (res) {
            _this.paymentData = res['data'];
        });
    };
    StudentAddComponent.prototype.getSubscriptionData = function () {
        var _this = this;
        this.apiService.getData('subscription/list?pageName=student').subscribe(function (res) {
            _this.subscriptionData = res['data'];
        });
    };
    StudentAddComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData('student/create/admin?pageName=student', this.detailForm.value).subscribe(function (res) {
    ...
    Object.defineProperty(StudentAddComponent.prototype, "fval", {
        get: function () {
    ...
    StudentAddComponent.prototype.backUrl = function () {
...
var StudentAddModule = /** @class */ (function () {
    function StudentAddModule() {
    }
...
//# sourceMappingURL=studentAdd-studentAdd-module-es5.js.map