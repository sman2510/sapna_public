...
var StudentListComponent = /** @class */ (function () {
    function StudentListComponent(apiService, exportService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    StudentListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('student/list?pageName=student').subscribe(function (res) {
    ...
    StudentListComponent.prototype.deleteData = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_12___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.apiService.saveData('student/delete?pageName=student', obj).subscribe(function (res) {
                    _this.listGetData();
    ...
    StudentListComponent.prototype.editData = function (id) {
        var _this = this;
        this.editID = id;
        this.SpinnerService.show();
        this.apiService.getData('student/list/' + id + '?pageName=student').subscribe(function (res) {
            _this.detailForm.controls['status'].setValue(res['data'].status);
            _this.SpinnerService.hide();
        });
    };
    StudentListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
    ...
    StudentListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    StudentListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(StudentListComponent.prototype, "fval", {
        get: function () {
    ...
    StudentListComponent.prototype.editStudent = function (id) {
        sessionStorage.setItem('studId', id);
        this.router.navigate(['/studentEdit']);
    };
    StudentListComponent.prototype.viewStudent = function (id) {
        sessionStorage.setItem('studId', id);
        this.router.navigate(['/studentView']);
    };
    StudentListComponent.prototype.getExcel = function () {
        this.SpinnerService.show();
...
//# sourceMappingURL=studentList-studentList-module-es5.js.map