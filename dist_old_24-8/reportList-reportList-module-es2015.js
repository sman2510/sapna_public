...
let ReportListRoutingModule = class ReportListRoutingModule {
};
...
let ReportListComponent = class ReportListComponent {
    constructor(apiService, modalService, router, formBuilder, toastr, SpinnerService, compFactory, viewRef, _renderer) {
    ...
    expandRow(trRef, rowData) {
        this.dtElement.dtInstance.then((dtInstance) => {
            ...
            if (row.child.isShown()) {
                ...
                let factory = this.compFactory.resolveComponentFactory(_child_child_component__WEBPACK_IMPORTED_MODULE_11__["ChildComponent"]);
...
let ReportListModule = class ReportListModule {
};
...
//# sourceMappingURL=reportList-reportList-module-es2015.js.map