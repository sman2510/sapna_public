...
var AssessmentComponent = /** @class */ (function () {
    function AssessmentComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    AssessmentComponent.prototype.getData = function () {
        var _this = this;
        ...
        this.apiService
            ...
            if (res["data"] && res["data"]["quiz"]) {
                _this.quizTitle = res["data"]["quiz"]["title"];
                _this.quizMinutes = res["data"]["quiz"]["minutes"];
                _this.dynamicArray =
                    res["data"]["quiz"]["quiz_question"];
                if (_this.dynamicArray.length == 0) {
                    _this.dynamicArray.push(_this.newDynamic);
                }
            }
    ...
    AssessmentComponent.prototype.uploadFile = function (event, id) {
        var _this = this;
        ...
        if (event.target.files.length > 0) {
            ...
            reader_1.onload = function (e) {
                ...
                _this.dynamicArray[id].q_image = reader_1.result;
            };
        }
        console.log(this.dynamicArray[id]);
    };
    AssessmentComponent.prototype.uploadFileA = function (event, id) {
        var _this = this;
        console.log(this.dynamicArray[id]);
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
            ...
            reader_2.onload = function (e) {
                // called once readAsDataURL is completed
                _this.dynamicArray[id].a_image = reader_2.result;
            };
        }
        console.log(this.dynamicArray[id]);
    };
    AssessmentComponent.prototype.uploadFileB = function (event, id) {
        var _this = this;
        console.log(this.dynamicArray[id]);
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
            ...
            reader_3.onload = function (e) {
                // called once readAsDataURL is completed
                _this.dynamicArray[id].b_image = reader_3.result;
            };
        }
        console.log(this.dynamicArray[id]);
    };
    AssessmentComponent.prototype.uploadFileC = function (event, id) {
        var _this = this;
        console.log(this.dynamicArray[id]);
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
            ...
            reader_4.onload = function (e) {
                // called once readAsDataURL is completed
                _this.dynamicArray[id].c_image = reader_4.result;
            };
        }
        console.log(this.dynamicArray[id]);
    };
    AssessmentComponent.prototype.uploadFileD = function (event, id) {
        var _this = this;
        console.log(this.dynamicArray[id]);
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
            ...
            reader_5.onload = function (e) {
                // called once readAsDataURL is completed
                _this.dynamicArray[id].d_image = reader_5.result;
            };
        }
        console.log(this.dynamicArray[id]);
    };
    AssessmentComponent.prototype.saveDetail = function () {
        var _this = this;
        var obj = {};
    ...
    AssessmentComponent.prototype.backUrl = function () {
        this.router.navigate(["/videoList"]);
    };
    AssessmentComponent.prototype.addRow = function (index) {
        this.newDynamic = {
            id: "",
            question: "",
            q_image: "",
    ...
    AssessmentComponent.prototype.deleteRow = function (index, id) {
        var _this = this;
...
//# sourceMappingURL=assessment-assessment-module-es5.js.map