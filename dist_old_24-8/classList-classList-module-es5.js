...
var ClassListRoutingModule = /** @class */ (function () {
    function ClassListRoutingModule() {
    }
...
var ClassListComponent = /** @class */ (function () {
    function ClassListComponent(apiService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    ClassListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('class/list?pageName=classes').subscribe(function (res) {
    ...
    ClassListComponent.prototype.editData = function (id) {
        var _this = this;
        this.SpinnerService.show();
        this.editID = id;
        this.apiService.getData('class/list/' + this.editID + '?pageName=classes').subscribe(function (res) {
            _this.detailForm.controls['class_name'].setValue(res['data'].class_name);
            _this.detailForm.controls['description'].setValue(res['data'].description);
            _this.SpinnerService.hide();
        });
    };
    ClassListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData(this.apiUrl, this.detailForm.value).subscribe(function (res) {
            ...
            if (res['status']) {
                ...
                _this.toastr.error(res['data']['class_name'][0]);
            }
        });
    };
    ClassListComponent.prototype.deleteData = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.apiService.saveData('class/delete?pageName=classes', obj).subscribe(function (res) {
                    _this.listGetData();
                    _this.toastr.success(res['message']);
                });
            }
    ...
    ClassListComponent.prototype.open = function (content, type, id) {
        var _this = this;
        this.submitted = false;
    ...
    ClassListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(ClassListComponent.prototype, "fval", {
        get: function () {
...
var ClassListModule = /** @class */ (function () {
