...
var ChangePasswordComponent = /** @class */ (function () {
    function ChangePasswordComponent(apiService, router, formBuilder, toastr, SpinnerService) {
    ...
    ChangePasswordComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData('changePassword', this.detailForm.value).subscribe(function (res) {
    ...
    Object.defineProperty(ChangePasswordComponent.prototype, "fval", {
        get: function () {
