...
var VendorDashboardRoutingModule = /** @class */ (function () {
    function VendorDashboardRoutingModule() {
    }
    ...
    return VendorDashboardRoutingModule;
}());
...
var VendorDashboardComponent = /** @class */ (function () {
    function VendorDashboardComponent(apiService, router, toastr, SpinnerService) {
    ...
    VendorDashboardComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('vendor/dashboard?pageName=vendor_dashboard').subscribe(function (res) {
            _this.listData = res['data']['commision_details'];
            _this.vendorData.push(res['data']['vendor_details']);
    ...
    VendorDashboardComponent.ctorParameters = function () { return [
...
var VendorDashboardModule = /** @class */ (function () {
    function VendorDashboardModule() {
    }
...
//# sourceMappingURL=vendorDashboard-vendorDashboard-module-es5.js.map