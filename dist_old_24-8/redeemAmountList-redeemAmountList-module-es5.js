...
var RedeemAmountListRoutingModule = /** @class */ (function () {
    function RedeemAmountListRoutingModule() {
    }
    ...
    return RedeemAmountListRoutingModule;
}());
...
var RedeemAmountListComponent = /** @class */ (function () {
    function RedeemAmountListComponent(apiService, exportService, modalService, router, formBuilder, toastr, SpinnerService) {
    ...
    RedeemAmountListComponent.prototype.ngOnInit = function () {
        this.dtOptions = {
    ...
    RedeemAmountListComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('student/redeem/pending/list?pageName=student').subscribe(function (res) {
            ...
            tempData.forEach(function (element) {
                ...
                if (element['mode'] == 'paytm') {
                    ...
                    _this.downloadData1.push(element);
                }
            });
    ...
    RedeemAmountListComponent.prototype.saveDetail = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.apiService.saveData('student/redeem/status/update', this.detailForm.value).subscribe(function (res) {
            _this.SpinnerService.hide();
            if (res['status']) {
    ...
    RedeemAmountListComponent.prototype.open = function (content, id) {
        var _this = this;
        this.submitted = false;
    ...
    RedeemAmountListComponent.prototype.getDismissReason = function (reason) {
    ...
    Object.defineProperty(RedeemAmountListComponent.prototype, "fval", {
        get: function () {
    ...
    RedeemAmountListComponent.prototype.getExcel = function () {
        this.SpinnerService.show();
        this.exportService.exportExcel(this.downloadData, 'Paytm');
        this.SpinnerService.hide();
    };
    RedeemAmountListComponent.prototype.getExcel1 = function () {
        this.SpinnerService.show();
        this.exportService.exportExcel(this.downloadData1, 'bank');
        this.SpinnerService.hide();
    };
    RedeemAmountListComponent.ctorParameters = function () { return [
    ...
    return RedeemAmountListComponent;
}());
...
var RedeemAmountListModule = /** @class */ (function () {
    function RedeemAmountListModule() {
    }
...
//# sourceMappingURL=redeemAmountList-redeemAmountList-module-es5.js.map