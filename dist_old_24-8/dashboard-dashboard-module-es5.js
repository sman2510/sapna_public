...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, apiService, toastr, SpinnerService) {
        this.router = router;
    ...
    DashboardComponent.prototype.listGetData = function () {
        var _this = this;
        this.SpinnerService.show();
        this.apiService.getData('dashboard?pageName=dashboard').subscribe(function (res) {
            var tempData = [];
